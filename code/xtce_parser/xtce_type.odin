...
t_ByteOrderCommonType_Enumeration := [?]string {
...
t_ConsequenceLevelType_Enumeration := [?]string {
	"normal",
	"vital",
	"critical",
	"forbidden",
...
t_ConcernLevelsType_Enumeration := [?]string {
	"normal",
	"watch",
	"warning",
	"distress",
...
t_StringEncodingType_Enumeration := [?]string {
	"US-ASCII",
	"ISO-8859-1",
	"Windows-1252",
	"UTF-8",
...
t_IntegerEncodingType_Enumeration := [?]string {
	"unsigned",
	"signMagnitude",
	"twosComplement",
	"onesComplement",
...
t_ReferenceLocationType_Enumeration := [?]string {
	"containerStart",
	"containerEnd",
	"previousEntry",
	"nextEntry",
...
t_TelemetryDataSourceType_Enumeration := [?]string {
	"telemetered",
	"derived",
	"constant",
	"local",
...
t_ValidationStatusType_Enumeration := [?]string {
	"Unknown",
	"Working",
	"Draft",
	"Test",
...
t_MathOperatorsType_Enumeration := [?]string {
	"+",
	"-",
	"*",
	"/",
...
t_TimeAssociationUnitType_Enumeration := [?]string {
	"si_nanosecond",
	"si_microsecond",
	"si_millsecond",
	"si_second",
...
t_FloatEncodingType_Enumeration := [?]string {
	"IEEE754_1985",
	"IEEE754",
	"MILSTD_1750A",
	"DEC",
...
t_VerifierEnumerationType_Enumeration := [?]string {
	"release",
	"transferredToRange",
	"sentFromRange",
	"received",
...
t_ChecksumType_Enumeration := [?]string {
	"unix_sum",
	"sum8",
	"sum16",
	"sum24",
